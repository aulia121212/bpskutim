        ...
        <div class="space-y-2" x-show="components.length > 0">
            <template x-for="(comp, i) in components" :key="i">
                <div class="rounded-xl border overflow-hidden"
                    ...
                    {{-- Expandable: Interpretasi per kategori --}}
                    <div x-show="comp.showInterp" x-collapse
                        class="border-t px-3 pb-3 pt-2 grid grid-cols-2 gap-3"
                        :class="comp.is_sub
                        ...
                        <div>
                            ...
                            <textarea
                                :name="'components[' + i + '][interpretasi_lebih_kecil]'"
                        ...
                        <div>
                            ...
                            <textarea
                                :name="'components[' + i + '][interpretasi_lebih_besar]'"
                        ...
                        {{-- Preview badge --}}
                        <div class="col-span-2 flex gap-2 flex-wrap" x-show="comp.interpretasi_lebih_kecil || comp.interpretasi_lebih_besar">
