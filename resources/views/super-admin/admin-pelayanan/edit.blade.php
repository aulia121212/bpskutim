...
<div class="p-6">
    ...
    {{-- Header --}}
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-800 dark:text-white">Edit Admin Pelayanan</h1>
    ...
    {{-- Form --}}
    <form action="{{ route('superadmin.admin-pelayanan.update', $admin->id) }}" method="POST" enctype="multipart/form-data">
        @csrf
        @method('PUT')
